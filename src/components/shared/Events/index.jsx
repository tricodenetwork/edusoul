...
export default function Events() {
  return (
    ...
    >
      <div className='flex lg:h-[792px] flex-col-reverse bg-[#8f060e]/5 lg:flex-row  mt-[50px] md:mt-[80px] px-5 xl:px-20 py-10 md:py-20 w-full gap-8 justify-center lg:items-center rounded'>
