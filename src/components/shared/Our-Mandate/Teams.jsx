    ...
    <>
      ...
      >
        <div className='flex flex-col md:flex-row w-full justify-start items-start gap-2'>
          <img
            className='md:flex hidden grow shrink basis-0 h-[535px] md:w-[50vw]'
            src='/assets/images/ideas/ideas-1.png'
          />

          <div className='grow shrink basis-0 p-6 bg-rose-200 lg:h-[535px] flex-col justify-start items-start gap-8 inline-flex'>
