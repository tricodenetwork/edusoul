...
const Index = () => {
  return (
    <div className='w-full flex-col md:flex-row flex bg-white justify-between px-3 sm:px-[20px] lg:px-[40px] pt-[24px]'>
      {/* First Section */}
          ...
          <div className='flex flex-col sm:flex-row w-full mt-[24px] justify-between gap-3 lg:px-[16px] items-center overflow-y-auto'>
            {[1, 2, 3].map((item) => (
              ...
              >
                ...
                <button className='bg-primary rounded-[8px] hidden md:flex justify-center w-full py-[8px] text-white mt-[24px] text-[10px] font-semibold'>
                  Continue Course
                </button>
        ...
        <div className='w-full border border-appAsh2 mb-[24px] p-3 lg:p-6 h-max bg-appPink rounded-[12px]'>
          ...
          <div className='bg-white rounded-[8px] p-4'>
            ...
            <div className='flex justify-between items-center'>
              <div className=''>
                {coursesData.slice(0, 5).map((item, i) => (
                  <div
                    key={i.toString()}
          ...
          <div className='bg-white mt-[24px] rounded-[8px] p-4'>
            ...
            <div>
              <div className='flex mb-[8px] items-center justify-normal space-x-2'>
                <div className='w-[6px] h-[6px] rounded-full bg-primary'></div>
                <p className='text-appBlack text-[12px]'>Biblical Studies</p>
              </div>
