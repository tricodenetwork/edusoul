...
const Accordion = ({
  ...
  return (
    <div className='flex w-full duration-300 flex-col text-black pt-2 my-2 justify-center items-start'>
      <div
        onClick={() => toggleAccordion(accordionId)}
        className='border-t w-full mx-auto cursor-pointer flex flex-row pt-4 gap-3 rounded-md justify-between items-center'
      >
        <p className={`text-[15px] md:text-[18.687px] w-full font-bold`}>{question}</p>
